...
// NOTE: This file uses the third configuration: allMeditationConfigs[2]

struct meditation3View: View {
    
    // 1. Configuration: Get the data for Flow Breathing 5-0-6-0
    private let config = allMeditationConfigs[2]
    
    // 2. StateObject: Initialize and manage the MeditationPlayer lifecycle
    @StateObject private var player: MeditationPlayer
    
    init() {
        let config = allMeditationConfigs[2]
